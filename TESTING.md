...
| `searchtechselector.js` | ![search tech selector js validaton screenshot on js hint](documentation/validation-images/js/jshint-searchtechselectorjs.png) | Same as warnings in `techselector.js`                                                                                                                                                                |
...
| File                                | Screenshot                                                                                                                          | Description                                                                                                                                                                                                                                                                                                                                       |
| ----------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| custom_account/forms.py             | ![custom accounts forms py validaton screenshot on pep8](documentation/validation-images/python/custom_account-forms.png)           | Pass                                                                                                                                                                                                                                                                                                                                              |
| custom_account/models.py            | ![custom accounts models py validaton screenshot on pep8](documentation/validation-images/python/custom_account-models.png)         | Pass                                                                                                                                                                                                                                                                                                                                              |
| custom_account/tests.py             | ![custom accounts tests py validaton screenshot on pep8](documentation/validation-images/python/custom_account-tests.png)           | Pass                                                                                                                                                                                                                                                                                                                                              |
| custom_account/views.py             | ![custom accounts views py validaton screenshot on pep8](documentation/validation-images/python/custom_account-views.png)           | Pass                                                                                                                                                                                                                                                                                                                                              |
| custom_account/adapters.py          | ![custom accounts adapters py validaton screenshot on pep8](documentation/validation-images/python/custom_account-adapters.png)     | Pass                                                                                                                                                                                                                                                                                                                                              |
| custom_account/urls.py              | ![custom accounts urls py validaton screenshot on pep8](documentation/validation-images/python/custom_account-urls.png)             | Pass                                                                                                                                                                                                                                                                                                                                              |
| custom_account/admin.py             | ![custom accounts admin py validaton screenshot on pep8](documentation/validation-images/python/custom_account-admin.png)           | Pass                                                                                                                                                                                                                                                                                                                                              |
| job_post/forms.py                   | ![job post forms py validaton screenshot on pep8](documentation/validation-images/python/job_post-forms.png)                        | Pass                                                                                                                                                                                                                                                                                                                                              |
| job_post/models.py                  | ![job post models py validaton screenshot on pep8](documentation/validation-images/python/job_post-models.png)                      | Pass                                                                                                                                                                                                                                                                                                                                              |
| job_post/tests.py                   | ![job post tests py validaton screenshot on pep8](documentation/validation-images/python/job_posts-tests.png)                       | Pass                                                                                                                                                                                                                                                                                                                                              |
| job_post/views.py                   | ![job post views py validaton screenshot on pep8](documentation/validation-images/python/job_post-views.png)                        | Pass                                                                                                                                                                                                                                                                                                                                              |
| job_post/urls.py                    | ![job post urls py validaton screenshot on pep8](documentation/validation-images/python/job_posts-urls.png)                         | Pass                                                                                                                                                                                                                                                                                                                                              |
| job_post/admin.py                   | ![job post admin py validaton screenshot on pep8](documentation/validation-images/python/job_post-admin.png)                        | Pass                                                                                                                                                                                                                                                                                                                                              |
| project/forms.py                    | ![project forms py validaton screenshot on pep8](documentation/validation-images/python/project-forms.png)                          | Pass                                                                                                                                                                                                                                                                                                                                              |
| project/models.py                   | ![project models py validaton screenshot on pep8](documentation/validation-images/python/project-models.png)                        | Pass                                                                                                                                                                                                                                                                                                                                              |
| project/tests.py                    | ![project tests py validaton screenshot on pep8](documentation/validation-images/python/project-tests.png)                          | Pass                                                                                                                                                                                                                                                                                                                                              |
| project/views.py                    | ![project views py validaton screenshot on pep8](documentation/validation-images/python/project-views.png)                          | Pass                                                                                                                                                                                                                                                                                                                                              |
| project/urls.py                     | ![project urls py validaton screenshot on pep8](documentation/validation-images/python/project-urls.png)                            | Pass                                                                                                                                                                                                                                                                                                                                              |
| project/admin.py                    | ![project admin py validaton screenshot on pep8](documentation/validation-images/python/project-admin.png)                          | Pass                                                                                                                                                                                                                                                                                                                                              |
| project/templatetags/helper_tags.py | ![project templatetags helper tags py validaton screenshot on pep8](documentation/validation-images/python/project-helper_tags.png) | Pass                                                                                                                                                                                                                                                                                                                                              |
| project/signals.py                  | ![project signals py validaton screenshot on pep8](documentation/validation-images/python/project-signals.png)                      | Pass                                                                                                                                                                                                                                                                                                                                              |
| search_and_filter/urls.py           | ![search and filter urls py validaton screenshot on pep8](documentation/validation-images/python/search_and_filter-urls.png)        | Pass                                                                                                                                                                                                                                                                                                                                              |
| search_and_filter/views.py          | ![search and filter views py validaton screenshot on pep8](documentation/validation-images/python/search_and_filter-views.png)      | Pass                                                                                                                                                                                                                                                                                                                                              |
| technology/admin.py                 | ![technology admin py validaton screenshot on pep8](documentation/validation-images/python/tech-admin.png)                          | Pass                                                                                                                                                                                                                                                                                                                                              |
| technology/models.py                | ![technology models py validaton screenshot on pep8](documentation/validation-images/python/tech-models.png)                        | Pass                                                                                                                                                                                                                                                                                                                                              |
| technology/tests.py                 | ![technology tests py validaton screenshot on pep8](documentation/validation-images/python/tech-tests.png)                          | Pass                                                                                                                                                                                                                                                                                                                                              |
| work_location_type/admin.py         | ![work location type admin py validaton screenshot on pep8](documentation/validation-images/python/wlt-admin.png)                   | Pass                                                                                                                                                                                                                                                                                                                                              |
| work_location_type/models.py        | ![work location type models py validaton screenshot on pep8](documentation/validation-images/python/wlt-models.png)                 | Pass                                                                                                                                                                                                                                                                                                                                              |
| stackportfolio/settings.py          | ![stackportfolio settings py validaton screenshot on pep8](documentation/validation-images/python/stackportfolio-settings_1.png)    | Pass - The warnings present in this file are for the Django contrib files, but it is recommended not to try to apply formatting to them. These lines can be seen in [screenshot 2](documentation/validation-images/python/stackportfolio-settings_2.png) and [screenshot 3](documentation/validation-images/python/stackportfolio-settings_3.png) |
| stackportfolio/urls.py              | ![stackportfolio urls py validaton screenshot on pep8](documentation/validation-images/python/stackportfolio-urls.png)              | Pass                                                                                                                                                                                                                                                                                                                                              |
| stackportfolio/utils.py             | ![stackportfolio utils py validaton screenshot on pep8](documentation/validation-images/python/stackportfolio-utils.png)            | Pass                                                                                                                                                                                                                                                                                                                                              |
